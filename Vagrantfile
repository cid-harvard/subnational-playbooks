...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.synced_folder "./colombia-prototype/", "/srv/colombia-prototype/", :create => true, :nfs => true
  config.bindfs.bind_folder "/srv/colombia-prototype/", "/srv/colombia-prototype/"
